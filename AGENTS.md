# AGENTS.md — íris · orquestração do projeto

> Este arquivo é lido no início de toda sessão. A **sessão principal age como orquestradora**: ela planeja, delega aos subagentes especialistas (`.Codex/agents/`) e integra o resultado. Subagentes NÃO se invocam entre si — quem coordena é esta sessão.
